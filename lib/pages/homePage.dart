...
class _Homepagetate extends State<Homepage> {
  ...
  builder: (BuildContext context, AsyncSnapshot<List<Employe>> snapshot) {
    ...
    , SizedBox(height: 100,child: Row(
      ...
      children: [Container(width: 250,height: 225,color: const Color.fromARGB(255, 168, 9, 86),child: Text("descriptiiiion completa nuevo feature Production new tag recien en prod  rama main "),),Container(width: 150,height: 225,color: const Color.fromARGB(255, 35, 130, 118),child: Text("ver mas Detalles aqui "),),],
    ),)
